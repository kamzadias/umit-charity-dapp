    ...
    return (
        <div className="surface-0 flex justify-content-center">
            <div id="home" className="landing-wrapper overflow-hidden">
                <div className="relative overflow-hidden" style={{ height: '43rem' }}>
                    <div className="absolute" style={{ top: 0, left: 0, padding: '40px 50px', zIndex: '1' }}>
                        <h2 className="text-white uppercase">ÜMIT</h2>
                    </div>
                    <video
                        autoPlay
                        muted
                    ...
                    >
                        <div className="absoluteBox">
                            ...
                            `}</style>
                            <h1 className="title text-white uppercase" style={{ maxWidth: '45rem', fontSize: '4em', fontWeight: 800 }}>
                                Empowering Charitable Giving with Blockchain
                            </h1>

                            <p className="mt-4 text-white" style={{ maxWidth: '700px', fontSize: '1.1em', fontWeight: 400 }}>
                                Experience a revolutionary charity platform that leverages blockchain for transparent, secure, and impactful donations to causes that matter.
                            </p>
                ...
                <div id="features container" className="py-4 px-4 lg:px-8 mx-0 lg:mx-8">
                    <div className="grid justify-content-center">
                        <div className="col-12 text-center mt-8 mb-4">
                            <h2 className="text-900 font-normal mb-2">Platform Statistics</h2>
                            <span className="text-600 text-2xl">Real-time insights into our charitable campaigns</span>
                        </div>
                ...
                <div id="highlights" className="py-4 px-4 lg:px-8 my-3 mx-0 lg:mx-8">
                    <div className="text-center">
                        <h2 className="text-900 font-normal mb-2">Global Impact Through Blockchain</h2>
                        <span className="text-600 text-2xl">Transforming charitable giving with secure, transparent technology.</span>
                    </div>
                    ...
                    <div className="grid mt-8 pb-2 md:pb-3">
                        ...
                        <div className="col-12 lg:col-6 my-auto flex flex-column lg:align-items-end text-center lg:text-right">
                            ...
                            <h2 className="line-height-1 text-900 text-4xl font-normal">Decentralized Trust</h2>
                    ...
                    <div className="grid my-3 pt-2 md:pt-4">
                        <div className="col-12 lg:col-6 my-auto flex flex-column text-center lg:text-left lg:align-items-start">
                            ...
                            <h2 className="line-height-1 text-900 text-4xl font-normal">Transparent Operations</h2>
                ...
                <div id="faq" className="py-4 px-4 lg:px-8 mx-0 lg:mx-8">
                    <div className="text-center mb-4">
                        <h2 className="text-900 font-normal mb-2">Frequently Asked Questions</h2>
                        <span className="text-600 text-2xl">Answers to common questions about our blockchain charity platform</span>
                    </div>
                    <Accordion multiple expandIcon="pi pi-plus" collapseIcon="pi pi-minus" className="w-full">
                        <AccordionTab header="How does blockchain enhance charity donations?" className="border-round-3xl text-lg">
                        ...
                        <AccordionTab header="Is my donation secure?" className="my-2 border-round-3xl text-lg">
                        ...
                        <AccordionTab header="Can I track the impact of my donation?" className="border-round-3xl text-lg">
                        ...
                        <AccordionTab header="How do I start contributing?" className="my-2 border-round-3xl text-lg">
                ...
                <div id="video" className="py-4 px-4 lg:px-8 mx-0 my-3">
                    <h3 className="text-center text-900 font-normal mb-3">Watch Our Platform Demo</h3>
                ...
                <div
                    className="relative overflow-hidden py-8 px-4 lg:px-8 mx-0 lg:mx-8 mb-5"
                    style={{
